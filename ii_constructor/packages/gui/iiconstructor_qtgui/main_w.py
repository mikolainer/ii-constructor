...
class MainWindow(QMainWindow):
    ...
    def __setup_ui(self):
        ...
        main_splitter = QSplitter(self, Qt.Orientation.Horizontal)
    ...
    def __setup_toolbar(self):
        ...
        self.__close_btn.icon_size *= 0.6
...
STATE_TEXT_MAX_LEN = 1000  # TODO: Переместить куда-то в константы
...
class NewProjectDialog(QDialog):
    ...
    def __init__(
        self,
        parent: QWidget | None = None,
        state_text_max_len: int = STATE_TEXT_MAX_LEN,
    ) -> None:
        self.state_text_max_len = state_text_max_len
...
class FlowList(QStackedWidget):
    ...
    def setWidget(self, item: QWidget, set_current: bool = False):
        ...
        if item not in self.__indexed.values():
        ...
        idx: int = list(self.__indexed.keys())[
            list(self.__indexed.values()).index(item)
        ]
