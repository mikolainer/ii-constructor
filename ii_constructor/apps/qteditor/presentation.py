...
from iiconstructor_maria.repo import HostingInterface, HostingMaria
from iiconstructor_qtgui.data import CustomDataRole, ItemData, Old_SynonymsSetModel, SynonymsSetModel
from iiconstructor_qtgui.flows import FlowListWidget, Old_FlowsModel, FlowsModel, FlowsView
...
from iiconstructor_qtgui.scene import Old_SceneControll, SceneControll
...
class Project:
    ...
    def manipulator(self) -> ScenarioAPI:
...
class ProjectManager:
    ...
    def create_project(self) -> Project:
        ...
        # создание проекта
        manipulator = Hosting.make_scenario(
    ...
    def open_file(self) -> Project:
        ...
        # создание проекта
        manipulator = Hosting.load_scenario(
            self.__inmem_hosting,
            data,
        )
    ...
    def db_connections(self):
        ...
        if self.__maria_hosting.connected():
            ...
            if selected_id == -1:  # create new
                ...
                manipulator = Hosting.open_scenario(
                    self.__maria_hosting,
                    selected_id,
                )
                scene_ctrl = self.__open_project(manipulator)
