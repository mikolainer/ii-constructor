...
from iiconstructor_qtgui.synonyms import SynonymsSelector, SynonymsEditor, SynonymsGroupsModel
from iiconstructor_qtgui.states import StatesModel
from iiconstructor_qtgui.main_w import FlowList, MainWindow, Workspaces, NewProjectDialog, MainToolButton
...
from iiconstructor_qtgui.steps import StepModel, StepEditor
...
class TestDialog(QWidget):
    ...
    def __init__(self, manipulator: ScenarioManipulator, parent: Optional[QWidget] = None) -> None:
        ...
        self.__engine = Engine(LevenshtainClassificator(manipulator.interface()), start_state)
